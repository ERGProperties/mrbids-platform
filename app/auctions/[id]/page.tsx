    ...
    <main className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mb-10">
            <div className="flex items-center gap-4 mb-4">
              <span className="inline-flex items-center px-4 py-1.5 text-xs font-medium rounded-full bg-green-100 text-green-800">
                ● Live Auction
              </span>
          ...
          <div className="mt-12 bg-white border border-gray-200 rounded-2xl p-8">
            ...
            <p className="mt-4 text-sm text-gray-600 leading-relaxed">
              ...
              acceptance of final bids. Participation is limited
              to verified buyers only.
            </p>
          </div>
        ...
        <aside className="bg-white border border-gray-200 rounded-2xl p-8 h-fit sticky top-32">
          ...
          <button
            disabled
            className="w-full py-4 rounded-full text-sm font-medium bg-gray-200 text-gray-500 cursor-not-allowed"
          >
